...
all: test1 test2 test3 omegaTest indeTest
...
indeTest.o: indeTest.c mol.h
	$(CC) $(CFLAGS) -c indeTest.c -o indeTest.o
...
indeTest: indeTest.o libmol.so
	$(CC) $(CFLAGS) indeTest.o -L. -lmol -lm -o indeTest
